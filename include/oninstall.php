 ...
 */
function xoops_module_pre_install_tools(XoopsModule $module)
{

    include __DIR__ . '/../preloads/autoloader.php';
    /** @var \Utility $utility */
    $utility = new \XoopsModules\Tools\Utility();
 ...
 */
function xoops_module_install_tools(XoopsModule $module)
{
