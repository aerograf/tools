 ...
 */
function xoops_module_pre_update_tools(\XoopsModule $module)
{
...
function xoops_module_update_tools(\XoopsModule $module, $previousVersion = null)
{
    $moduleDirName = basename(dirname(__DIR__));
    ...
    /** @var Tools\Helper $helper */
    /** @var Tools\Utility $utility */
    /** @var Tools\Configurator $configurator */
    $helper  = Tools\Helper::getInstance();
    $utility = new Tools\Utility();
    $configurator = new Tools\Configurator();

    if ($previousVersion < 240) {

        //rename column EXAMPLE
        $tables     = new Tables();
        $table      = 'toolsx_categories';
        $column     = 'ordre';
        $newName    = 'order';
